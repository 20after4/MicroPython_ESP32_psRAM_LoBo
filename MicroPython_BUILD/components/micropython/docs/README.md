...
[Building MicroPython](https://github.com/loboris/MicroPython_ESP32_psRAM_LoBo/blob/master/MicroPython_BUILD/components/micropython/docs/build.md)
...
### Other MicroPython documentation

[MicroPython documentation - pyboard](http://docs.micropython.org/en/latest/pyboard/)

[MicroPython documentation - ESP8266](https://docs.micropython.org/en/latest/esp8266/index.html)
